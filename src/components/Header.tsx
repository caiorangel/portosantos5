    ...
    >
      <nav className="container mx-auto px-4">
        <div className="flex items-center justify-center md:justify-between">
          ...
          <button 
            className="md:hidden absolute right-4 z-50 p-2 focus:outline-none"
        ...
        <div 
          className={`fixed inset-0 bg-white/95 backdrop-blur-md transition-transform duration-300 transform md:hidden ${
